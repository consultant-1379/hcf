#ifndef __INCLUDE_GUARD_CLASS_SRV_IMM_OBJECT_HCSINGLE_EVENT__
#define __INCLUDE_GUARD_CLASS_SRV_IMM_OBJECT_HCSINGLE_EVENT__ imm_object_hcsingle_event

/**
 *  @file imm_object_hcsingle_event.h
 *	@brief
...
public:
	inline TSL_CTOR (const char * class_name)
		TSL_CTOR_INIT_LIST(imm_object(class_name), job_scheduling_policy(), _scheduled_time(),
				_scheduler(), _timeplan(), _mutex(), _scheduled_time_old(), _timeplan_old()) {}
...
public:
	...
	//==================//
public:
	inline std::string get_scheduled_time () const { return _scheduled_time; }
...
private:
	...
	//========//
public:
	static const char * const HCF_HCSINGLE_EVENT_CLASS_NAME;
	static const char * const HCF_HCSINGLE_EVENT_IMPLEMENTER_NAME;
	static const char * const HCF_HCSINGLE_EVENT_ID_ATTR_NAME;
	static const char * const HCF_HCSINGLE_EVENT_SCHEDULED_TIME_ATTR_NAME;
	static const char * const HCF_HCSINGLE_EVENT_ID_SEPARATOR_VALUE;

private:
	std::string _scheduled_time;
	std::string _scheduler;
	TSL_NS_HCF_CORE::oneshot_alarm_timeplan _timeplan;
	...
	std::string _scheduled_time_old;
	TSL_NS_HCF_CORE::oneshot_alarm_timeplan _timeplan_old;
};

HCF_NS_HCF_SRV_END

#endif	// __INCLUDE_GUARD_CLASS_SRV_IMM_OBJECT_HCSINGLE_EVENT__
