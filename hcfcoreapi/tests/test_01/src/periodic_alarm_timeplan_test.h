#ifndef __INCLUDE_GUARD_CLASS_PERIODIC_ALARM_TIMEPLAN_TEST__
#define __INCLUDE_GUARD_CLASS_PERIODIC_ALARM_TIMEPLAN_TEST__ periodic_alarm_timeplan_test
...
#endif /* __INCLUDE_GUARD_CLASS_PERIODIC_ALARM_TIMEPLAN_TEST__ */
